...
export enum HighfieldState {
  ...
  SCANNING_GROUND = 'SCANNING_GROUND',
  ADJUSTING_SENSORS = 'ADJUSTING_SENSORS',
  CONTEMPLATING_DEEP = 'CONTEMPLATING_DEEP',
  STRETCHING_BOOTS = 'STRETCHING_BOOTS',
  CHECKING_WEB_SHOOTERS = 'CHECKING_WEB_SHOOTERS',
}
